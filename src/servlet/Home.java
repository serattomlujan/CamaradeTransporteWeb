...
public class Home extends HttpServlet {
	...
	private void ValidaPreguntaSecreta(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		CtrlAdministrador ctrl = new CtrlAdministrador();
		Administrador a = new Administrador();
		a.setCorreo(request.getParameter("correo"));
		System.out.println(a.getCorreo());
		a.setPreguntaSecreta(request.getParameter("pregunta"));
		try {
	...
	private void login(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if (adm != null) {
				...
				request.setAttribute("encontrado", a);
